...
for keyboard in keyboards:
    ...
    keyboard_xml.set("nameResId", pretty_language + " " + keyboard_type_pretty)
    keyboard_xml.set("iconResId", "@drawable/ic_status_" + language)
    keyboard_xml.set("layoutResId", "@xml/" + language + "_" + keyboard_type_pretty)
    keyboard_xml.set("id", md5)
    keyboard_xml.set("defaultDictionaryLocale", lang_short)
    keyboard_xml.set("description", pretty_language + " " + keyboard_type_pretty)
...
new_dictionaries = language + "/pack/src/main/res/xml/" + language + "_" + "dictionaries.xml"
